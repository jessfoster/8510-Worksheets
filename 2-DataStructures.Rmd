...
> This code subsets the values in rows 100 to 110 of the City column in gayguides. It creates a matrix populated by rows. So the value in the 100th row of the City column, "San Diego," starts the matrix and it continues across five columns of the matrix before starting a new row.
