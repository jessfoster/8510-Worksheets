...
```{r}
# This line removes all rows from the dataframe with "NA"
statepopulations.Filtered <- statepopulations[complete.cases(statepopulations$X1800), ]
# This line sorts the filtered dataframe by the X1800 column in ascending order
...
Voters.By.Occupation("Lithographer")
```
> I can't get this to work for occupations with numerous entries like "Housewife" or "Stenographer". I just picked an occupation with only one row.