...
tidy.mind.body %>%
  ...
  print(n = Inf) # print all rows
```
> There doesn't seem to be a clear patternn here. The word "boys" is more frequent in January, February, March, May, May-June, June, July, August, September, and October, while "girls" is more frequent in
